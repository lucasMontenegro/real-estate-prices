...
const useStyles = makeStyles(theme => ({
  ...
  coverRow: {
    width: '100%',
    overflow: 'hidden',
    background: 'linear-gradient(180deg, rgba(143,188,241,1) 0%, rgba(255,255,255,1) 70%)',
    display: 'flex',
...
function Page (props) {
  ...
  let rootClass = classes.root, coverClass = classes.cover
  if (props.permDrawer) {
  ...
  return (
    <div className={rootClass}>
      <AppBar className={classes.header} position="static" color="default" elevation={1}>
